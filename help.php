	...
	<div class="navbar-inner owl-gradient">
		<div class="container"> 
		  <a class="brand"  href="javascript:void(0)" onclick="kazihome()">
			<h2 class="title"><img src="_img/kazi_gif.gif" style="height:30px;" /></h2>
		  </a>
	    ...
	    <div class="span12">
	      <div class="widget">
			...
			<div class="widget-content">
			  <ol class="faq-list">
				<li>
				  <h4>What is KaziWeb? How does the system work?</h4>
				  ...
				  <p>KaziWeb is a job seacrh website that automates the screening and shortlisting processes of recruitment. 
				...
				<li>
				  <h4>Who is behind KaziWeb?</h4>
				  <p> KaziWeb is a privately held company with global ambitions and consists of a well seasoned
				  management team and advisors. Omae Kelvin 'Don' founded this company.</p>	
				</li>
				<li>
				  <h4> Is KaziWeb a recruitment firm?</h4>
				  <p> No. KaziWeb is NOT a recruitment agency. We do not do candidate interviewing but automate short-listing. 
				...
				<li>
				  <h4>Do I need a PC before i can visit www.kaziweb.com?</h4>
				  <p> No. You can also access www.kaziweb.com on your mobile phone. But we strong recommend a PC, just to enhance your experience on the website.</p>	
				</li>
				<li>
				  <h4>What happens when I apply online for jobs posted on www.kaziweb.com?</h4>
	  ...
	  <div class="row" style="margin-top:5px">
	    <div class="span12">
	      <div class="widget">
			...
			<div class="widget-content">
			  <ul>
				<li><h4><a href="javascript:void(0)" onclick="kazihome()">Front page</a></h4></li>
