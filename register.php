	...
	if($fo == "" || $eo == "" || $po == "" || $userrole == "" || $lo == ""){
		...
		$sql_note = "INSERT INTO notifications (note_type, e_hash, note, date_time) 
										VALUES (
												'a',
												'$eo_hash',
												'Hello $fo. Thanks for joining KaziWeb. We hope you get excited when you consider the possibilities of landing your dream job. We can not wait for you to get started. You might want to start by:<br>- Tailoring your Profile <br> Your profile is a virtual representation of your physical CV. Make a good one.',
												now())";
		...
		$subject = 'KaziWeb Account Activation';
		...
		$message .= '<div style="padding: 20px;background-color: rgb(217, 226, 245);"><a href="http://www.kaziweb.com/activation.php?id='.$uid.'&e='.$eo.'&e_hash='.$eo_hash.'&p='.$po.'">Click here to activate your account now</a></div><br />';
		$message .= '<div style="padding: 20px;background-color: rgb(217, 216, 245);">Activation string: <br /> '.$eo_hash.'</div>';
		$message .= '<br /><br /><br /><b>KaziWeb Team</b></span></body></html>';
	...
	if($r_eo == "" || $company_name == "" || $b_stream == "" || $comp_contact == ""){
		...
		$_note = "INSERT INTO notifications (note_type, e_hash, note, date_time) 
										VALUES (
												'a',
												'$r_eo',
												'Hello $company_name. Thanks for joining KaziWeb. We hope you get excited when you consider the possibilities of landing the best employees. We can not wait for you to get started. You might want to start by:<br>- Posting a Job',
												now())";
		...
		$message .= 'Next, please confirm your email address and activate your account by either clicking on the link below or using your activation string.<br /><br /><br />';
		$message .= '<div style="padding: 20px;background-color: rgb(217, 226, 245);"><a href="http://www.kaziweb.com/activation.php?id='.$oid.'&e='.$r_eo.'&e_hash='.$r_eo_hash.'&p='.$r_pwd.'">Click here to activate your account now</a></div><br />';
	...
	<div class="navbar-inner">
		<div class="container"> 
		  ...
		  <a class="brand"  href="javascript:void(0)" onclick="kazihome()">
			<img src="_img/kazi_log.png" style="height:30px;" />
			<span></span>
		  </a>
	  ...
	  <div class="content clearfix">	
		<form role="form" method="post" onSubmit="return false;">
		  <div class="register-logo">
			<span><img src="_img/kazi_log.png" style="width:55px;" /></span>
												   ...
												   '<div class="content clearfix">'+
													 '<form role="form" method="post" onSubmit="return false;">'+
													   '<div class="register-logo">'+
														 ...
														 '<p style="font-weight: lighter; font-size: 14px;">Please check your email in a couple of minutes, for your activation information. NOTE: You need to activate your account in order to use our system.</p>'+	
