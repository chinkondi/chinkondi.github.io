      ...
      <div class="nav-collapse index">
		<form class="navbar-search strict-mobile-no-show"  role="form" method="post" onSubmit="return false;">
		  ...
		  <input type="password" class="search-query" placeholder="Password" id="password" name="password" onkeyup="restrict('password')"/>
		   <span id="signinbtn"><button id="loginbtn" class="btn btn-primary" onclick="signin()">Sign in</button></span>&nbsp;
	...
	<div class="row">
	  <div class="span10 banner-span">
		<div class="banner-text">
		  <p class="banner-text-md">Welcome to the KaziWeb</p>
		  <p class="banner-text-lg" style="font-size: 3.4em;line-height: 40px;">This is a job recruitment portal that speeds-up the current employee recruitment process using the internet.</p>
